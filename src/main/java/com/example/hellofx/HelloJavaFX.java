...
public class HelloJavaFX extends Application {    @Override    public void start(Stage stage) {        Label message = new Label("Welcome to JavaFX!");        Button button = new Button("Click Me");
    ...
    Scene scene = new Scene(layout, 500, 300);        stage.setTitle("My First JavaFX Application");        stage.setScene(scene);        stage.show();    }
